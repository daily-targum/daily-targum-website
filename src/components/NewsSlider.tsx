      ...
      <Section>
        ...
        >
          ...
          <Text className={styles.byline}>
            {formatDateAbbreviated(article.publishDate)} -{" "}
...
export function NewsSlider({ articles }: { articles: CompactArticle[] }) {
  ...
  return (
    <div style={{ position: "relative" }} {...handlers}>
      <div
        className={cn("force-dark-mode", styles.slider)}
