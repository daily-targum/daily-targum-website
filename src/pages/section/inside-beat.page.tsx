  ...
  return (
    <Section className={styles.page}>
      <Semantic role="main" pritable skipNavContent>
        <Banner text="Inside" accentText="Beat" legacy />
        ...
        <Grid.Row spacing={theme.spacing(2.5)}>
          <Grid.Col xs={24} md={12}>
            <Card.StackedResponsive
              ...
              date={formatDateAbbreviated(articles[0].publishDate)}
              author={articles[0].authors.map((a) => a.displayName).join(", ")}
              altText={
                articles[0].media[0]?.altText ??
                articles[0].media[0]?.description ??
                undefined
              }
            />
          </Grid.Col>
          ...
          <Grid.Col xs={24} md={12}>
            <Card.StackedResponsive
              ...
              as={"/" + articles[1].slug}
              aspectRatioDesktop={2 / 1}
              date={formatDateAbbreviated(articles[1].publishDate)}
              author={articles[1].authors.map((a) => a.displayName).join(", ")}
              altText={
                articles[1].media[0]?.altText ??
                articles[1].media[0]?.description ??
                undefined
              }
            />
          </Grid.Col>
